            ...
            <>
              {cameraSupported && !cameraError ? (
                ...
                <div style={{ textAlign: 'center', color: 'white', padding: '40px' }}>
                  ...
                  <button onClick={() => openCamera(selectedChicken)} style={{ marginTop: '30px', background: colors.redAccent, color: 'white', padding: '15px 40px', border: 'none', borderRadius: '25px', fontSize: '18px', fontWeight: '600', cursor: 'pointer' }}>Choose Photo</button>
                </div>
              )}
            </>
          ) : (
    ...
    return (
      <div style={{ background: colors.cream, minHeight: '100vh', paddingBottom: '80px' }}>
        ...
        <div style={{ padding: '20px' }}>
          ...
          <Button
            onClick={() => openCamera(selectedChicken)}
            primary
          ...
          {selectedChicken.photos && selectedChicken.photos.length > 0 ? (
            ...
            <div style={{
              ...
              <p style={{ color: colors.textMuted, fontSize: '14px' }}>
                Tap "Take Photo" above to start your collection
              </p>
            </div>
          )}
        </div>
